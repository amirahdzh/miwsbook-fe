      ...
      <div class="flex flex-wrap">
        <div class="w-full self-center px-8 lg:w-1/2">
          <h1 class="text-base text-secondary md:text-xl">
            ...
            <span class="block font-bold text-dark text-3xl font-dellarespira lg:text-3xl xl:text-4xl mt-4">
              Where Every Page is a New Adventure
            </span>
          </h1>
          <p class="text-dark mt-4 leading-relaxed lg:text-lg">
            Welcome to
            <span class="text-primary font-bold font-dellarespira">Book World</span>, where every book is a new adventure waiting to be explored. Our extensive collection caters to readers of all ages and interests, from timeless classics to the latest bestsellers.
          </p>
          <div class="mt-8 flex items-center space-x-4">
            ...
            <div class="relative flex-grow">
              ...
              <ul v-if="searchResults.length > 0" class="absolute bg-white shadow-lg rounded-md mt-2 w-full z-10">
                <li
        ...
        <div class="w-full self-end px-4 lg:w-1/2">
          <div class="relative mt-10 lg:mt-9 lg:right-0">
            ...
            <span class="absolute -bottom-0 -z-10 left-1/2 -translate-x-1/2 md:scale-125">
              <svg width="600" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
                <path
                  fill="#14b8a6"
